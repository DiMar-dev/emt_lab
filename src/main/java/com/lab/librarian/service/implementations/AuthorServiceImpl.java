...
public class AuthorServiceImpl implements AuthorService {
    ...
    public Optional<Author> save(AuthorDto authorDto) {
        Country country= countryRepository.findById(authorDto.getCountry())
                .orElseThrow(() -> new CountryNotFound(authorDto.getCountry()));

        return Optional.of(this.authorRepository.save(new Author(authorDto.getName(),
    ...
    public Optional<Author> edit(Long id, AuthorDto authorDto) {
        Author author=this.authorRepository.findById(id).orElseThrow(() -> new AuhtorNotFoundException(id));
